...
{ 
   define("_REQUESTEDFIELD","<span style='font-size:80%; color:#ff0000;'>*</span><span style='font-size:80%;'>必填欄位，不可空白</span>");
   define("_JSPREFIX","錯誤訊息:");
}
else
{
   define("_REQUESTEDFIELD","<span style='font-size:80%; color:#ff0000;'>*</span><span style='font-size:80%;'>denotes required field</span>"); 
   define("_JSPREFIX",'Invalid information entered.');
}
    /**
...
class HTML_QuickForm extends HTML_Common
{
    ...
    var $_requiredNote = _REQUESTEDFIELD;
